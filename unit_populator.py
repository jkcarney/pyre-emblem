...
def get_nonterminal_unit_base_stats(unit_name):
    character_dict = {
        'Sain': BlueUnit(0xd2f8, 0, 0, 1, 0xe7c, 19, 8, 4, 6, 4, 6, 0, 0, True, [0x14, 0x6b], False),
        'Kent': BlueUnit(0xd2c4, 0, 0, 1, 0xe7c, 20, 6, 6, 7, 2, 5, 1, 0, True, [0x1, 0x6b], False),
        'Florina': BlueUnit(0xd3fc, 0, 0, 1, 0x11c4, 17, 5, 7, 9, 7, 4, 4, 0, True, [0x14, 0x6b], False),
        'Wil': BlueUnit(0xd0f0, 0, 0, 2, 0x93c, 20, 6, 5, 5, 6, 5, 0, 0, True, [0x2c, 0x6b], False),
        'Dorcas': BlueUnit(0xcfb8, 0, 0, 3, 0x744, 30, 7, 7, 6, 3, 3, 0, 0, True, [0x28, 0x6b], False),
        'Erk': BlueUnit(0xd1f4, 0, 0, 1, 0xbdc, 17, 0, 6, 7, 3, 2, 4, 5, True, [0x37, 0x6b], False),
        'Rath': BlueUnit(0xd3c8, 0, 0, 7, 0x1074, 25, 8, 9, 10, 5, 7, 2, 0, True, [0x2c, 0x6b, 0x6b], False),
        'Matthew': BlueUnit(0xd534, 0, 0, 2, 0x150c, 18, 4, 4, 11, 2, 3, 0, 0, True, [0x1, 0x6b], False),
        'Lucius': BlueUnit(0xd158, 0, 0, 3, 0xa8c, 18, 0, 6, 10, 2, 1, 6, 7, True, [0x3e, 0x6b], False),
        'Marcus': BlueUnit(0xd360, 0, 0, 1, 0xf24, 31, 15, 15, 11, 8, 10, 8, 0, True, [0x17, 0x6b], False),
        'Lowen': BlueUnit(0xd32c, 0, 0, 2, 0xe7c, 23, 7, 5, 7, 3, 7, 0, 0, True, [0x1c, 0x6b], False),
        'Rebecca': BlueUnit(0xd0f0, 0, 0, 1, 0x990, 17, 4, 5, 6, 4, 3, 1, 0, True, [0x2c, 0x6b], False),
        'Bartre': BlueUnit(0xcfec, 0, 0, 2, 0x744, 29, 9, 5, 3, 4, 4, 0, 0, True, [0x1f, 0x6b], False),
        'Oswin': BlueUnit(0xd054, 0, 0, 9, 0x7ec, 29, 13, 9, 5, 3, 13, 3, 0, True, [0x14, 0x6c], False),
        'Guy': BlueUnit(0xcf50, 0, 0, 3, 0x5f4, 21, 6, 11, 11, 5, 5, 0, 0, True, [0xd, 0x6c], False),
        'Raven': BlueUnit(0xcee8, 0, 0, 5, 0x4a4, 25, 8, 11, 13, 2, 5, 1, 0, True, [0x3, 0x6c], False),
        'Canas': BlueUnit(0xd290, 0, 0, 8, 0xd2c, 21, 0, 9, 8, 7, 5, 8, 10, True, [0x44, 0x6c], False),
        'Dart': BlueUnit(0xd874, 0, 0, 8, 0x1464, 34, 12, 8, 8, 3, 6, 1, 0, True, [0x20, 0x6c], False),
        'Heath': BlueUnit(0xd498, 0, 0, 7, 0x126c, 28, 11, 8, 7, 7, 10, 1, 0, True, [0x16, 0x6c], False)
    }
...
def get_terminal_unit_base_stats(unit_name):
    character_dict = {
        'Lyn': BlueUnit(0xceb4, 0, 0, 1, 0x204, 16, 4, 7, 9, 5, 2, 0, 0, True, [0xa, 0x6c], True),
        'Eliwood': BlueUnit(0xce4c, 0, 0, 1, 0x1b0, 18, 5, 5, 7, 7, 5, 0, 0, True, [0x9, 0x6c], True),
        'Hector': BlueUnit(0xce80, 0, 0, 1, 0x258, 19, 7, 4, 5, 3, 8, 0, 0, True, [0x8d, 0x6c], True)
    }
    return character_dict[unit_name]
